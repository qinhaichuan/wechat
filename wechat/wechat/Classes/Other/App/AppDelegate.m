...
//    self.window.rootViewController = tabBarVc;
    ...
    EMOptions *options = [EMOptions optionsWithAppkey:@"q-hc#wechat"];
    options.apnsCertName = @"wechat_dev";
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "QHC.wechat" in the application's documents directory.
